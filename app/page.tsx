    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-gradient-to-b from-emerald-50 to-white">
      <div className="w-full max-w-md text-center space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-slate-600">Encuentra tu compañero deportivo ideal</p>
        </div>

        <div className="relative w-full h-64 mx-auto overflow-hidden rounded-2xl shadow-lg">
          <img
            src="/placeholder.svg?height=400&width=600"
            alt="Personas practicando deportes juntas"
            className="object-cover w-full h-full"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-6">
            <p className="text-white text-lg font-medium">Conéctate con deportistas de tu mismo nivel</p>
          </div>
        </div>
