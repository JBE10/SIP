      ...
      <Card className="w-full max-w-md bg-gray-800/80 backdrop-blur-sm border border-gray-700 text-white">
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white border border-white" disabled={isLoading}>
        ...
        <CardFooter className="flex flex-col space-y-4">
          ...
          <div className="flex gap-2">
            <Button variant="outline" className="w-full bg-gray-700 border border-gray-500 text-gray-200 hover:bg-gray-600 hover:border-blue-400">
            ...
            <Button variant="outline" className="w-full bg-gray-700 border border-gray-500 text-gray-200 hover:bg-gray-600 hover:border-blue-600">
